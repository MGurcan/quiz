...
import { SuperLigTeamLogos, SuperLigTeams } from "./SuperLig";

export const Big6Teams = Array.prototype.concat(BundesligaTeams, LaligaTeams, Ligue1Teams, PremierLeagueTeams, SerieATeams, SuperLigTeams);
